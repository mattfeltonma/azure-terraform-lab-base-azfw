...
########## Create additional non-human Azure RBAC role assignments when system-assigned managed identity is used
##########
##########
...
## AML storage account to the compute instance user-assigned managed identity
...
## AML storage account to the development compute instance user-assigned managed identity
