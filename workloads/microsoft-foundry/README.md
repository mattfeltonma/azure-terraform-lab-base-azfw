...
| `apim_ai_gateway` | `object` | `null` | Configuration to setup [BYO model feature](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/ai-gateway?tabs=api-management&pivots=foundry-portal). See [terraform-tfvars.sample](terraform-tfvars.sample) for example. |
| `model_gateway` | `object`| `null`| Configuration to setup [BYO model feature](https://learn.microsoft.com/en-us/azure/foundry/agents/how-to/ai-gateway?tabs=api-management&pivots=foundry-portal). See [terraform-tfvars.sample](terraform-tfvars.sample) for example. |
